...
var Navigation = function () {
    ...
    return (_jsxs("div", __assign({ className: CSS.cal_nav }, { children: [renderDateSelector(), _jsxs("div", { children: [_jsx(Button, __assign({ onClick: function () { return handleState(new Date(), "selectedDate"); } }, { children: "Today" }), void 0),
                    views.length > 1 &&
