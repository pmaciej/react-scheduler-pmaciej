...
var ResourcesTables = function (_a) {
    ...
    return (_jsx("tr", { children: resources.map(function (res, i) { return (_jsx("td", { children: _jsxs("table", __assign({ className: CSS.table + " " + CSS["table_" + direction], style: {
                ...
                } }, { children: [_jsx("tbody", __assign({ className: CSS.noborder }, { children: _jsx("tr", { children: _jsx("td", __assign({ colSpan: span }, { children: _jsx(ResourceHeader, { resource: res }, void 0) }), void 0) }, void 0) }), void 0),
                    _jsx("tbody", { children: renderChildren(res) }, void 0)] }), void 0) }, res[resourceFields.idField] + "_" + i)); }) }, void 0));
};
