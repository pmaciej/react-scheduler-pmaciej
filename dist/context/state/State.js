...
var AppState = function (_a) {
    ...
    var confirmEvent = function (event, action) {
        ...
        if (action === "edit") {
            ...
            updatedEvents = __spreadArray(__spreadArray([], state.events), [event]);
        }
                    ...
                    if (resField) {
                        ...
                        if (isMultiple) {
                            ...
                            if (currentRes.includes(resVal)) {
                                ...
                                newResource =
                                    currentRes.length > 1 ? __spreadArray(__spreadArray([], currentRes), [resVal]) : [resVal];
                            }
                        }
                    }
    ...
    return (_jsx(StateContext.Provider, __assign({ value: __assign(__assign({}, state), { handleState: handleState,
            getViews: getViews,
            triggerDialog: triggerDialog,
            triggerLoading: triggerLoading,
            handleGotoDay: handleGotoDay,
            confirmEvent: confirmEvent,
            onDrop: onDrop }) }, { children: children }), void 0));
};
export { AppState };
