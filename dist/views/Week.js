...
var Week = function () {
    ...
    var renderTable = function (resource) {
        ...
        return (_jsxs(Fragment, { children: [_jsxs("tr", { children: [_jsx("td", { className: CSS.indent + " " + CSS.borderd }, void 0),
                        _jsx("td", __assign({ className: CSS.borderd }, { children: _jsx("table", __assign({ className: CSS.table + " " + CSS.week_day_table }, { children: _jsx("tbody", { children: _jsx("tr", { children: daysList.map(function (date, i) { return (_jsxs("td", __assign({ className: isToday(date) ? CSS.today_cell : "", style: {
                                                ...
                                                borderLeft: direction === "ltr"
                                                    ? i === 0
                                                        ...
                                                        : "1px solid #eeeeee"
                                                    : "",
                                            } }, { children: [_jsx(TodayTypo, { date: date, onClick: handleGotoDay }, void 0), renderMultiDayEvents(recousedEvents, date)] }), i)); }) }, void 0) }, void 0) }), void 0) }), void 0)] }, void 0),
                _jsxs("tr", { children: [_jsx("td", __assign({ className: CSS.borderd }, { children: _jsxs("table", __assign({ className: CSS.table + " " + CSS.hour_table }, { children: [_jsx("thead", { children: _jsx("tr", { children: _jsx("td", {}, void 0) }, void 0) }, void 0),
                                    _jsx("tbody", { children: hours.map(function (h, i) { return (_jsx("tr", { children: _jsx("td", { children: _jsx("div", __assign({ style: { height: CELL_HEIGHT } }, { children: _jsx(Typography, __assign({ variant: "caption" }, { children: format(h, "hh:mm a", { locale: locale }) }), void 0) }), void 0) }, void 0) }, i)); }) }, void 0)] }), void 0) }), void 0),
                        _jsx("td", __assign({ className: CSS.borderd }, { children: _jsxs("table", __assign({ className: CSS.table + " " + CSS.cells_table + " " + CSS["cells_table_" + direction] + " " }, { children: [_jsx("thead", { children: _jsx("tr", { children: daysList.map(function (date, i) { return (_jsx("td", { children: _jsx(TodayEvents, { todayEvents: recousedEvents
                                                        .filter(function (e) {
                                                        return isSameDay(date, e.start) &&
                                                            !differenceInDays(e.end, e.start);
                                                    })
                                                        .sort(function (a, b) { return a.end.getTime() - b.end.getTime(); }), today: date, minuteHeight: MINUTE_HEIGHT, cellHeight: CELL_HEIGHT, startHour: startHour, step: step, direction: direction }, void 0) }, i)); }) }, void 0) }, void 0),
                                    _jsx("tbody", { children: hours.map(function (h, i) { return (_jsx("tr", { children: daysList.map(function (date, i) {
                                                var _a;
