...
var Editor = function () {
        ...
        switch (stateItem.type) {
            ...
            case "date":
                return (_jsx(EditorDatePicker, __assign({ value: stateItem.value, name: key, onChange: function () {
                        ...
                        return handleEditorState.apply(void 0, __spreadArray(__spreadArray([], args), [true]));
    ...
    var renderEditor = function () {
        ...
        return (_jsxs(Fragment, { children: [_jsx(DialogTitle, { children: selectedEvent ? "Edit Event" : "Add Event" }, void 0),
                _jsx(DialogContent, __assign({ style: { overflowX: "hidden" } }, { children: _jsx(Grid, __assign({ container: true, spacing: 1 }, { children: Object.keys(state).map(function (key) {
                            var _a;
                            var item = state[key];
                            return (_jsx(Grid, __assign({ item: true, sm: (_a = item.config) === null || _a === void 0 ? void 0 : _a.sm, xs: 12 }, { children: renderInputs(key) }), key));
                        }) }), void 0) }), void 0),
                _jsxs(DialogActions, { children: [_jsx(Button, __assign({ color: "inherit", fullWidth: true, onClick: function () { return handleClose(); } }, { children: "Cancel" }), void 0),
                        _jsx(Button, __assign({ color: "primary", fullWidth: true, onClick: handleConfirm }, { children: "Confirm" }), void 0)] }, void 0)] }, void 0));
    };
