...
var Day = function () {
    ...
    var renderTable = function (resource) {
        ...
        return (_jsxs(Fragment, { children: [_jsxs("tr", { children: [_jsx("td", { className: CSS.day_indent + " " + CSS.borderd }, void 0),
                        _jsx("td", __assign({ className: CSS.borderd }, { children: _jsx("table", __assign({ className: CSS.table + " " + CSS.week_day_table }, { children: _jsx("tbody", { children: _jsx("tr", { children: _jsxs("td", __assign({ className: isToday(selectedDate) ? CSS.today_cell : "", style: { border: 0 } }, { children: [_jsx(TodayTypo, { date: selectedDate }, void 0), renderMultiDayEvents(recousedEvents)] }), void 0) }, void 0) }, void 0) }), void 0) }), void 0)] }, void 0),
                _jsxs("tr", { children: [_jsx("td", __assign({ className: CSS.borderd }, { children: _jsxs("table", __assign({ className: CSS.table + " " + CSS.hour_table }, { children: [_jsx("thead", { children: _jsx("tr", { children: _jsx("td", {}, void 0) }, void 0) }, void 0),
                        ...
                        _jsx("td", __assign({ className: CSS.borderd }, { children: _jsxs("table", __assign({ className: CSS.table + " " + CSS.cells_table + " " + CSS["cells_table_" + direction] }, { children: [_jsx("thead", { children: _jsx("tr", { children: _jsx("td", { children: _jsx(TodayEvents, { todayEvents: recousedEvents.filter(function (e) {
                                                        return !differenceInDays(e.end, e.start) &&
                                                            isSameDay(selectedDate, e.start);
                                                    }), today: selectedDate, minuteHeight: MINUTE_HEIGHT, cellHeight: CELL_HEIGHT, startHour: startHour, step: step, direction: direction }, void 0) }, void 0) }, void 0) }, void 0),
                                    _jsx("tbody", { children: hours.map(function (h, i) {
                                            var _a;
