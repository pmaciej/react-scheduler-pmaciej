...
var Month = function () {
        ...
        var _loop_1 = function (startDay) {
            var cells = weekDays.map(function (d) {
                ...
                return (_jsx("td", { children: _jsx(Cell, __assign({ height: CELL_HEIGHT, start: start, end: end, resourceKey: field, resourceVal: resource ? resource[field] : null }, { children: _jsxs(Fragment, { children: [_jsx(Avatar, __assign({ style: {
                                ...
                                _jsx("div", __assign({ className: CSS.events_col }, { children: _jsx(MonthEvents, { events: recousedEvents, today: today, eachWeekStart: eachWeekStart, daysList: daysList, onViewMore: handleGotoDay }, void 0) }), void 0)] }, void 0) }), void 0) }, d.toString()));
            });
    ...
    var renderTable = function (resource) {
        return (_jsxs(Fragment, { children: [_jsx("tr", { children: _jsx("td", { children: _jsx("table", __assign({ className: CSS.table + " " + CSS.month_day_table + " " + CSS["month_day_table_" + direction] }, { children: _jsx("tbody", { children: _jsx("tr", { children: renderDays() }, void 0) }, void 0) }), void 0) }, void 0) }, void 0),
                _jsx("tr", { children: _jsx("td", { children: _jsx("table", __assign({ className: CSS.table + " " + CSS.month_cells + " " + CSS["month_cells_" + direction] }, { children: _jsx("tbody", { children: renderCells(resource) }, void 0) }), void 0) }, void 0) }, void 0)] }, void 0));
    };
